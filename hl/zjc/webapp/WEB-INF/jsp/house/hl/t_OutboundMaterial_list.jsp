...
<aos:onready>
	...
	<aos:viewport layout="border">
		...
		<aos:gridpanel id="_g_qgtjorder" url="HtController.OutboundMaterial" onrender="_g_qgtjorder_query" region="center" pageSize="10" >
			...
			<aos:column header="出库账号" dataIndex="user_account" />
			<aos:column header="出库人名称" dataIndex="user_name" />
			<aos:column header="出库时间" dataIndex="add_time" />
			<aos:column header="出库数量" dataIndex="num" />
			<aos:column header="当前剩余库存" dataIndex="unmbers" />
		</aos:gridpanel>
