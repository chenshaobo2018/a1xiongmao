...
<aos:onready >
	<aos:viewport layout="border" >
		...
		<!-- 会员主数据 -->
		<aos:gridpanel id="g_param" url="zjcUsersInfoService.getUserList"   region="center" onitemdblclick="w_zjcUser_u_show" >
			<aos:docked forceBoder="1 0 1 0">
				<aos:dockeditem xtype="tbtext" text="会员信息" />
			</aos:docked>
			<aos:column type="rowno" />
			<aos:column hidden="true" dataIndex="user_id" align="center"/>
			...
			<aos:column header="注册时间" dataIndex="reg_time" align="center" width="150"/>
	...
	<aos:window id="w_user_detial" title="会员编辑" onshow="getUserDetial">
		<aos:formpanel id="f_zjcUser_u" width="800" layout="anchor" labelWidth="150" >
		    ...
		    <aos:textfield name="real_name" id="real_names" fieldLabel="真实姓名" readOnly="true" allowBlank="true" maxLength="50" />
		    ...
		    <aos:textfield name="id_card" id="id_cards" fieldLabel="身份证号码" readOnly="true" allowBlank="true" maxLength="80" />
		    <aos:textfield name="openid" id="openid"  fieldLabel="微信绑定" readOnly="true" emptyText="暂未绑定微信" allowBlank="true" maxLength="80" />
			<aos:textfield name="mobile" id="mobiles"  fieldLabel="手机号码" allowBlank="true" maxLength="50" readOnly="true"/>
			<aos:radioboxgroup fieldLabel="冻结 "  columns="3"  columnWidth="0.53" disabled="true">
			...
			<aos:radioboxgroup fieldLabel="是否禁用会员功能 " columns="3"  columnWidth="0.53" disabled="true">
			...
			<aos:radioboxgroup fieldLabel="云易财富 " columns="3"  columnWidth="0.53" disabled="true">
				...
				<aos:radiobox name="settlement_center_tc"  boxLabel="否" inputValue="0"  />
			</aos:radioboxgroup> 
		</aos:formpanel>
	...
	<!--查询下级代码  -->
		 <aos:window id="w_user" title="下级"  layout="border" maximized="true" onshow="g_param_querys">
			<aos:gridpanel  id="g_params" url="zjcUsersInfoService.queryUserJuniorList"  forceFit="true" region="center" onrender="g_param_querys"
				onitemdblclick="UserFirstLeader" headerBorder="true">
	...
	<!-- 查看积分日志 -->
		<aos:window id="w_users" title="日志"  layout="border" maximized="true" onshow="user_log">
		  ...
		  //会员主数据按钮列转换
			function fn_button_render(value, metaData, record, rowIndex, colIndex,
				...
				return '<input type="button" value="编辑" class="cbtn_danger" onclick="showAlertUser();" />'
				      +	'<input type="button" value="下级" class="cbtn_danger" onclick="UserFirstLeader();" />'  
