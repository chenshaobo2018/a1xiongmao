...
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:gridpanel id="g_order"  url="zjcOrderService.listZjcOrders&pay_code=mixed_payment" onrender="order_query" region="center">
			<aos:docked forceBoder="1 0 1 0">
				<aos:dockeditem xtype="tbtext" text="混合支付订单列表" /> 
			</aos:docked>
			...
			<%-- <aos:column header="发货时间" dataIndex="shipping_time" rendererFn="format_shippingTime" celltip="true" width="100"/>
			<aos:column header="收货时间" dataIndex="confirm_time" rendererFn="format_confirmTime" celltip="true" width="100"/> --%>
		</aos:gridpanel>
	</aos:viewport>
	...
	<script type="text/javascript">
		...
		function fn_export_excel(){
			...
			AOS.file('do.jhtml?router=zjcOrderService.exportOrderInfo&juid=${juid}&store_name='+encodeURI(encodeURI(params.store_name)) +'&user_id='+params.user_id  +'&order_sn='+params.order_sn
					+ '&order_status=' + params.order_status +'&pay_code=mixed_payment&pay_status=' + params.pay_status + '&shipping_status=' + params.shipping_status
