...
<aos:onready>
	<aos:viewport layout="border">
		...
		<aos:gridpanel id="g_order"  url="zjcOrderService.listZjcOrders&pay_status=0&order_status=0&pay_code=cash" onrender="order_query" region="center">
			...
			<%-- <aos:column header="商家电话" dataIndex="contacts_phone" celltip="true"/> --%>
			...
			<aos:column header="支付方式" dataIndex="pay_code" rendererField="pay_code_name" width="70"/>
	...
	<script type="text/javascript">
		...
		function fn_export_excel(){
			...
			AOS.file('do.jhtml?router=zjcOrderService.exportOrderInfo&juid=${juid}&pay_code=cash&pay_status=0&order_status=0&store_name='+encodeURI(encodeURI(params.store_name)) +'&user_id='+params.user_id +'&order_sn='+params.order_sn
