...
<aos:html title="webide" base="http" lib="ext,buttons,filter">
<aos:body>
</aos:body>
</aos:html>
<aos:onready>
	<aos:viewport layout="border">
		<aos:treepanel id="_t_project" region="west" bodyBorder="0 1 0 0" width="300" singleClick="true"
			url="coderService.listProjectTree" nodeParam="path" rootId="aosroot_" rootText="" rootIcon="icon25.gif"
		...
		<%-- <aos:iframe region="center" loadMask="${page_load_msg_ }" src="coderService.fileInit" /> --%>

		<aos:window id="_w_dao" title="批量生成Dao层代码" width="850" height="-10" layout="fit" onshow="_w_dao_onshow">
			<aos:gridpanel id="_g_dao" bodyBorder="1 0 0 0" url="coderService.listTables" hidePagebar="true"
