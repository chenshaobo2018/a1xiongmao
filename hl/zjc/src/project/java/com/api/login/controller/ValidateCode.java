...
public class ValidateCode {  
    ...
    {  
        ...
        {  
            //设置干扰线的起始坐标  
            int x1 = new Random().nextInt(WIDTH);     //产生0到WIDTH的随机数  
            int y1 = new Random().nextInt(HEIGHT);    //产生0到HEIGHT的随机数  
            //设置干扰线的终点坐标  
     ...
     public String drawRandomNum(Graphics2D g)  {  
       ...
       // 验证码范围,去掉0(数字)和O(拼音)容易混淆的(小写的1和L也可以去掉,大写不用了)  
        ...
        {  
            ...
            sb.append(ch);
            int degree = new Random().nextInt()%30;    //产生-30到30的随机数  
            g.rotate(degree*Math.PI/180,x,20);         //设置旋转弧度  
            g.drawString(ch,x,20);  
            //为了不影响下一个字书写角度，写完一个字后要将角度转回  
