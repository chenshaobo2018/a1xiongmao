...
public class SDKConstants {
	...
	public static final String backUrl = "https://zjc1518.com/aosuite/notokenapi/app/v1/unionRechargeBack.jhtml";
	public static final String orderbackUrl = "https://zjc1518.com/aosuite/notokenapi/app/v1/unionRechargeBackOrder.jhtml";
	public static final String PAY_CODE = "unionpay";
	public static final String PAY_NAME = "银联支付";
	public static final String MIXED_PAY_CODE = "mixed_payment";
	public static final String MIXED_PAY_NAME = "混合支付-银联";
	/** 接入类型. */
