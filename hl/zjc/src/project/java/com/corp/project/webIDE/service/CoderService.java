...
//		httpModel.setResponse(httpModel.getResponse());
		httpModel.setViewPath("project/webIDE/coder/coder.jsp");
	}
	 ...
	 * @return
	 */
	public void fileInit(HttpModel httpModel) {
//		httpModel.setAttribute("juid", httpModel.getInDto().getString("juid"));
//		httpModel.setResponse(httpModel.getResponse());
		httpModel.setViewPath("project/webIDE/coder/fileDetail.jsp");
	}
	 ...
	 * @throws SQLException 
	 */
	public void listTables(HttpModel httpModel) throws SQLException {
		Dto inDto = httpModel.getInDto();
		List<TableVO> tableVOs = this.listTablesDD(inDto);
...
//		WebCxt.write(response, outString);
	 ...
	 * @throws IOException
	 */
	public void listProjectTree(HttpModel httpModel) throws IOException {
		Dto queryDto = httpModel.getInDto();
	    List<TreeNode> fileList = this.listProjectViewDD(queryDto);  
	 ...
	 * @throws SQLException 
	 */
	public void buildDaoCode(HttpModel httpModel) throws SQLException {
		if (StringUtils.equals(WebCxt.getCfgOfDB("run_mode_"), "2")) {
			throw new AOSException();
		}
		Dto inDto = httpModel.getInDto();
		
		this.buildDaoCodeDD(inDto);
		//httpModel.setOutMsg("Dao代码生成成功，请刷新工程后重启服务器。");
		WebCxt.write(httpModel.getResponse(), "Dao代码生成成功，请刷新工程后重启服务器。");
	}
	 ...
	 * @return
	 */
	public List<ColumnVO> listColumnsDD(Dto pDto) {
	 ...
	 * @return
	 */
	public List<TreeNode> listTablesAsTreeDD(Dto pDto) {
	 ...
	 * @throws SQLException
	 */
	public List<TableVO> listTablesDD(Dto inDto) throws SQLException {
	 ...
	 * @return
	 */
	public String selectTableCommentDD(String tableNameString) {
		String commnet = "";
		return commnet;
	}
	 ...
	 * @return
	 */
	public List<TreeNode> listProjectViewDD(Dto queryDto) {
	 ...
	 * @throws SQLException 
	 */
	public void buildDaoCodeDD(Dto inDto) throws SQLException {
		inDto.put("package", inDto.getString("package_"));
		inDto.put("author", "AHei");
		String[] tables = inDto.getRows("aos_rows_");
