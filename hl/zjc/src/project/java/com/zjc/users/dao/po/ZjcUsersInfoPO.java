...
/**
 * <b>zjc_users_info[zjc_users_info]数据持久化对象</b>
 * <p>
 ...
 */
public class ZjcUsersInfoPO extends PO {
	...
	/**
	 * 会员登录时的设备类型：android 1 ,IOS 2,weixin 3
	 */
	...
	public void setZjcUsersAccountInfoPO(ZjcUsersAccountInfoPO zjcUsersAccountInfoPO) {
		ZjcUsersAccountInfoPO = zjcUsersAccountInfoPO;
	}
	/**
	 * 用户发货地址表
	 */
	private ZjcUserAddressPO  ZjcUserAddressPO;
	

	public ZjcUserAddressPO getZjcUserAddressPO() {
		return ZjcUserAddressPO;
	}

	public void setZjcUserAddressPO(ZjcUserAddressPO zjcUserAddressPO) {
		ZjcUserAddressPO = zjcUserAddressPO;
	}
	...
	public String getOpenid_s() {
		return openid_s;
	}

	public void setOpenid_s(String openid_s) {
		this.openid_s = openid_s;
	}
	...
	public ZjcUsersInfoPO(BigInteger user_id,Integer qualified_member) {
		super();
		this.user_id = user_id;
		this.qualified_member = qualified_member;
	}

	public ZjcUsersInfoPO() {
		super();
	}
}
