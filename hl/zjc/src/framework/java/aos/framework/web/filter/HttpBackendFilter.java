...
public class HttpBackendFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (StringUtils.equalsIgnoreCase(router, "homeService.initLogin")
				...
				|| StringUtils.equalsIgnoreCase(router, "zjcHomeService.initZjcLogin")
				|| StringUtils.equalsIgnoreCase(router, "zjcHomeService.initZjcLogin")
				|| StringUtils.equalsIgnoreCase(router, "zjcHomeService.initWxZjcLogin")
				|| StringUtils.equalsIgnoreCase(router, "HtController.saveT_goodsPO")) {
		...
		if (!pass) {
			...
			if(router.contains("zjcHomeService")){
				httpResponse.getWriter().write("<script type=\"text/javascript\">parent.location.href='"
						+ httpRequest.getContextPath() + "/http/do.jhtml?router=zjcHomeService.initZjcLogin'</script>");
			}else{
				httpResponse.getWriter().write("<script type=\"text/javascript\">parent.location.href='"
