...
public class HomeService {
	 ...
	 * @return
	 */
	public void upload(HttpModel httpModel) {
		...
		httpModel.setAttribute("juid", httpModel.getInDto().getString("juid"));
		httpModel.setViewPath("project/zjc/common/upload.jsp");
	}
	 ...
	 * @return
	 */
	public void storeLogoUpload(HttpModel httpModel) {
		String paramkey = httpModel.getInDto().getString("paramkey");
		if(StringUtils.isNotEmpty(paramkey)){
			String [] stringArr = AOSCxt.getParam(paramkey).split(":");
			Double prop = Double.parseDouble(stringArr[0]) / Double.parseDouble(stringArr[1]);
		...
		httpModel.setAttribute("juid", httpModel.getInDto().getString("juid"));
		httpModel.setViewPath("project/zjc/common/storeLogoUpload.jsp");
	}
	 ...
	 * @return
	 */
	public void newGoodsUpload(HttpModel httpModel) {
		String paramkey = httpModel.getInDto().getString("paramkey");
		...
		httpModel.setViewPath("project/zjc/common/newGoodsPicUpload.jsp");
	}
	 ...
	 * @param httpModel
	 */
	public void goodsPicUpload(HttpModel httpModel){
		String paramkey = httpModel.getInDto().getString("paramkey");
		if(StringUtils.isNotEmpty(paramkey)){
			String [] stringArr = AOSCxt.getParam(paramkey).split(":");
			Double prop = Double.parseDouble(stringArr[0]) / Double.parseDouble(stringArr[1]);
		...
		httpModel.setAttribute("juid", httpModel.getInDto().getString("juid"));
		httpModel.setViewPath("project/zjc/common/goodsPicUpload.jsp");
	}
	/**
	 * 用户登录
	 * 
